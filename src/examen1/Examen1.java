...
public class Examen1 {
    ...
    static ArrayList<String> extraerDiasDeSemana(ArrayList<String> palabras) {
        ...
        for (int i = 0; i < palabras.size(); i++) {
            if (!palabras.get(i).equals("lunes")
                    && !palabras.get(i).equals("martes")
                    && !palabras.get(i).equals("miercoles")
                    && !palabras.get(i).equals("jueves")
                    && !palabras.get(i).equals("viernes")
                    && !palabras.get(i).equals("sabado")
                    && !palabras.get(i).equals("domingo")) {
